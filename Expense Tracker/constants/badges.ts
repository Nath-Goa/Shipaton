...
export const BADGE_INFO: Record<string, BadgeInfo> = {
  ...
  course_brokerage_accounts: { label: 'Account Opened', icon: '💼' },
  course_etfs_index_funds: { label: 'Fund Fluent', icon: '🧩' },
  course_capital_gains_tax: { label: 'Tax Aware', icon: '🧾' },
  course_financial_statements: { label: 'Statement Reader', icon: '📑' },
  course_options_basics: { label: 'Options Curious', icon: '🔀' },
  course_behavioral_biases: { label: 'Self-Aware Investor', icon: '🧠' },
  ...
  stage_4_complete: { label: 'Practical & Real-World Complete', icon: '💎' },
