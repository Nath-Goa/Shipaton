...
const styles = StyleSheet.create({
  ...
  heroText: { fontSize: 12.5, lineHeight: 17, marginTop: 2 },
  ...
  toolTitle: { fontSize: 14, fontWeight: '700', flexShrink: 1 },
  toolSummary: { fontSize: 11.5, lineHeight: 16, marginTop: 2 },
  tierPill: { borderWidth: 1, borderRadius: radius.pill, paddingHorizontal: 6, paddingVertical: 1 },
  tierPillText: { fontSize: 9.5, fontWeight: '800', textTransform: 'uppercase' },
  ...
  numberInput: { flex: 1, minWidth: 48, fontSize: 14, paddingVertical: spacing.sm },
  affix: { fontSize: 12, fontWeight: '600' },
  ...
  resultValue: { fontSize: 22, fontWeight: '800', marginTop: 2 },
  resultDetail: { fontSize: 11.5, lineHeight: 16, marginTop: 3 },
  emptyCard: { alignItems: 'center', gap: spacing.sm, paddingVertical: spacing.xl },
  emptyTitle: { fontSize: 14, fontWeight: '700' },
  disclaimer: { fontSize: 10.5, lineHeight: 15, textAlign: 'center', marginTop: spacing.sm },
});
