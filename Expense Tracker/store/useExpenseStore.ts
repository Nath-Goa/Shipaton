  ...
  persist(
    (set, get) => ({
      ...
      addExpense: (input) => {
        ...
        // Round-up savings only fires for a directly logged expense, never
        // for a recurring instance auto-generated by generateDueRecurring —
        // catching up months of those at once shouldn't dump a pile of
        // round-ups into a goal in one go.
        useSavingsGoalStore.getState().contributeRoundUp(input.amount);
      },
