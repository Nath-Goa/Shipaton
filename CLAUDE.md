...
- **A new EAS build**, whenever one is next requested — `expo-speech` (§5.8) has been sitting installed-but-inert since this session; that's the point where "Read aloud" starts actually speaking on a device.
